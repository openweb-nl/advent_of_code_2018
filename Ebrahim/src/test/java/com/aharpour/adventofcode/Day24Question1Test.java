...
public class Day24Question1Test {

    @Test
    public void givenCase() throws Day24Question1.StalemateException {
        Day24Question1 question = new Day24Question1("Immune System:\n" +
                "17 units each with 5390 hit points (weak to radiation, bludgeoning) with an attack that does 4507 fire damage at initiative 2\n" +
                "989 units each with 1274 hit points (immune to fire; weak to bludgeoning, slashing) with an attack that does 25 slashing damage at initiative 3\n" +
                "\n" +
                "Infection:\n" +
                "801 units each with 4706 hit points (weak to radiation) with an attack that does 116 bludgeoning damage at initiative 1\n" +
                "4485 units each with 2961 hit points (immune to radiation; weak to fire, cold) with an attack that does 12 slashing damage at initiative 4", true);
        Assert.assertEquals(5216, question.calculate());
    }

    @Test
    public void realCase() throws Day24Question1.StalemateException {
        Day24Question1 question = new Day24Question1("Immune System:\n" +
                ...
                "3198 units each with 25539 hit points (immune to radiation, fire) with an attack that does 15 bludgeoning damage at initiative 17", false);
        Assert.assertEquals(14799, question.calculate());
    }
